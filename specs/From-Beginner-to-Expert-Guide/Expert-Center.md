...
> 来源: https://www.codebuddy.cn/docs/workbuddy/From-Beginner-to-Expert-Guide/Function-Description/Expert-Center
> 抓取: 2026-08-03
...
> 说明：专家本身不主动获取系统权限，仅处理您主动提供的对话与上传文件。当配备了 Skill / MCP 时才会在您的授权下间接访问文件或外部服务。
...
专家卡片展示能力介绍、擅长领域和任务示例。
专家团卡片展示能力介绍、擅长领域、团队成员和任务示例。
...
|------|-------|------------------|---------------------|
| 组成关系 | 工具能力：让AI能做某件事 | AI顾问：懂某个领域的 AI 角色 | AI协作团队：自动拆解、并行执行、完整交付 |
