...
AgentResourceType = Literal["skill", "general_skill", "knowledge_base", "tool", "mcp"]
...
class AgentProfileCreateRequest(BaseModel):
    ...
    # BspBuddy extensions (stored in metadata by the handler)
    bindings: Optional[dict[str, Any]] = None
    bspbuddy_status: Optional[str] = None  # 'draft' | 'online' | 'offline'
...
class AgentModelBindingInput(BaseModel):
    ...
    expert_model_catalog_id: Optional[str] = None
